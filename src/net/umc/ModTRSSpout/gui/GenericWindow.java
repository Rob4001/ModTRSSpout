...
import org.getspout.spoutapi.player.SpoutPlayer;
	...
	public class GenericWindow extends GenericPopup {
		...
		public GenericWindow(String title, SpoutPlayer player){
			this.title = title;
			background = new GenericTexture("http://rob4001.webs.com/Bukkit/SpoutRecs/messageBoxBG.png");
			...
			attachWidget(ModTRSSpout.getInstance(),background);
			...
			attachWidget(ModTRSSpout.getInstance(),titleLabel);
			setDirty(true);
		}
